...
public var _firingAnimationLeft:String;

public var _firingAnimationRight:String;

public var _firingAnimationDown:String;

public var _firingAnimationUp:String;
...
{
                if((actor.isAnimationPlaying() == true))
{
                    if((((actor.getAnimation() == _firingAnimationRight) || (actor.getAnimation() == _firingAnimationLeft)) || ((actor.getAnimation() == _firingAnimationUp) || (actor.getAnimation() == _firingAnimationDown))))
{
                ...
                if((actor.getAnimation() == _firingAnimationRight))
{
                    getLastCreatedActor().setXVelocity(_XSpeed);
}

                if((actor.getAnimation() == _firingAnimationLeft))
{
                    getLastCreatedActor().setXVelocity(-(_XSpeed));
}

                if((actor.getAnimation() == _firingAnimationUp))
{
                    getLastCreatedActor().setYVelocity(_YSpeed);
}

                if((actor.getAnimation() == _firingAnimationDown))
{
                    getLastCreatedActor().setYVelocity(-(_YSpeed));
}
