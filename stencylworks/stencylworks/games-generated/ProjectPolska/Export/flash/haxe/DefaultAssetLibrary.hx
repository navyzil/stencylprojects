...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/graphics/1x/sprite-117-0.png", __ASSET__assets_graphics_1x_sprite_117_0_png);
		type.set ("assets/graphics/1x/sprite-117-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		type.set ("assets/graphics/1x/sprite-115-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/graphics/1x/sprite-117-0.png", "assets/graphics/1x/sprite-117-0.png");
		type.set ("assets/graphics/1x/sprite-117-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
...
class __ASSET__assets_graphics_1x_sprite_117_0_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
