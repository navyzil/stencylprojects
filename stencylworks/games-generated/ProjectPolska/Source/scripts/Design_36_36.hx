...
class Design_36_36 extends ActorScript
{          	
...
public var _turnAroundAfterinseconds:Float;
...
_WalkingSpeed = 0.0;
nameMap.set("turnAroundAfter(in seconds)", "_turnAroundAfterinseconds");
_turnAroundAfterinseconds = 0;
        ...
        if((actor.getAnimation() == _WalkLeftAnimation))
{
        ...
        runPeriodically(1000 * _turnAroundAfterinseconds, function(timeTask:TimedTask):Void {
