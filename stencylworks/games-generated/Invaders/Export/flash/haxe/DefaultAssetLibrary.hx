...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/graphics/1x/background-6-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		className.set ("assets/graphics/1x/font-9.fnt", __ASSET__assets_graphics_1x_font_9_fnt);
		type.set ("assets/graphics/1x/font-9.fnt", Reflect.field (AssetType, "binary".toUpperCase ()));
		className.set ("assets/graphics/1x/font-9.png", __ASSET__assets_graphics_1x_font_9_png);
		type.set ("assets/graphics/1x/font-9.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		type.set ("assets/graphics/1x/sprite-5-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		className.set ("assets/music/sound-7.mp3", __ASSET__assets_music_sound_7_mp3);
		type.set ("assets/music/sound-7.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
		...
		path.set ("assets/graphics/1x/background-6-0.png", "assets/graphics/1x/background-6-0.png");
		type.set ("assets/graphics/1x/background-6-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/graphics/1x/font-9.fnt", "assets/graphics/1x/font-9.fnt");
		type.set ("assets/graphics/1x/font-9.fnt", Reflect.field (AssetType, "binary".toUpperCase ()));
		path.set ("assets/graphics/1x/font-9.png", "assets/graphics/1x/font-9.png");
		type.set ("assets/graphics/1x/font-9.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		type.set ("assets/graphics/1x/sprite-3-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/graphics/1x/sprite-5-0.png", "assets/graphics/1x/sprite-5-0.png");
		type.set ("assets/graphics/1x/sprite-5-0.png", Reflect.field (AssetType, "image".toUpperCase ()));
		...
		type.set ("assets/graphics/preloader-bg@4x.png", Reflect.field (AssetType, "image".toUpperCase ()));
		path.set ("assets/music/sound-7.mp3", "assets/music/sound-7.mp3");
		type.set ("assets/music/sound-7.mp3", Reflect.field (AssetType, "music".toUpperCase ()));
...
class __ASSET__assets_graphics_1x_background_6_0_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
class __ASSET__assets_graphics_1x_font_9_fnt extends flash.utils.ByteArray { }
class __ASSET__assets_graphics_1x_font_9_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class __ASSET__assets_graphics_1x_sprite_5_0_png extends flash.display.BitmapData { public function new () { super (0, 0); } }
...
class __ASSET__assets_music_sound_7_mp3 extends flash.media.Sound { }
