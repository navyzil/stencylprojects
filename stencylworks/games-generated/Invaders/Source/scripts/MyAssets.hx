...
class MyAssets implements AssetLoader
{
	...
	{
		var i = 0;
		var increment = 50.0 / Math.max(1, 10);
...
com.stencyl.Data.instance.updatePreloader(15 + Std.int(increment * i));
i++;
		resourceMap.set("9.fnt", Assets.getText("assets/graphics/" + Engine.IMG_BASE + "/font-9.fnt"));
		resourceMap.set("9.png", Assets.getBitmapData("assets/graphics/" + Engine.IMG_BASE + "/font-9.png", false));
com.stencyl.Data.instance.updatePreloader(15 + Std.int(increment * i));
i++;
	}
